export const categorydata = {
  fintech: {
    ...
    featured: 'Cashwise',
    featuredImg: '/images/fintech.jpg',
    featuredTxt:
      'An AI-powered personal finance assistant that helps users optimize their spending, savings, and investments.',
    project1: 'CryptoSafe',
    project2: 'BudgetMate',
    project3: 'Investify'
  },
  healthtech: {
    ...
    featured: 'HealthView ',
    featuredImg: '/images/healthtech.jpg',
    featuredTxt:
      'A mobile app that tracks your health metrics and provides personalized recommendations to improve your wellness.',
    project1: 'MediConnect',
    project2: 'Mindful',
    project3: 'WellFit'
  },
  fnb: {
    ...
    featured: 'PlatePal',
    featuredImg: '/images/fnb.jpg',
    featuredTxt:
      'An AI-powered food ordering system that learns your preferences and suggests dishes based on your taste and dietary restrictions.',
    project1: 'Bitesight',
    project2: 'RecipeGenie',
    project3: 'SmartServe'
  },
  socialmedia: {
    ...
    featured: 'FriendFy',
    featuredImg: '/images/socialmedia.jpg',
    featuredTxt:
      'A social media platform that uses machine learning to match users with like-minded people and groups based on their interests and activity.',
    project1: 'TrendHive',
    project2: 'LinkUp',
    project3: 'CircleChat'
  },
  games: {
    ...
    featured: 'GameVision',
    featuredImg: '/images/games.jpg',
    featuredTxt:
      'A computer vision platform that uses machine learning to identify and track player movements in real-time for immersive gaming experiences.',
    project1: 'CrowdPlay',
    project2: 'LevelUp',
    project3: 'Playdate'
  },
